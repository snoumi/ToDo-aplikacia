        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>Uprav úlohu
                        <a href="{{ route('tabulka.index', ['search' => $search]) }}" class="btn btn-primary float-end">Naspäť</a>
                    </h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('tabulka.update', $tabulka->id) }}" method="POST">
                      ...
                      @method('PUT')
                       ...
                       <div class="mb-3">
                        <label>Tagy</label>
                        <input type="text" name="tags" class="form-control" value="{{ $tabulka->tags }}" placeholder="napr. tag1, tag2, tag3">
